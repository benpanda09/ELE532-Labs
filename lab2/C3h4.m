...
%The plot showed very similar properties to the sine function and that the
%duration of the signal from the convolution of the two signal the total
%duration of the function. 

%S2, S3, S4 have similar waveform
